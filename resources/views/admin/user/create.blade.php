...
@section('content')
	<div class="card card-primary">
		...
		<form method="POST" name="frmTable" id="frmTable" action="{{ $model::getAdminRouteByDotNotation('store') }}" enctype="multipart/form-data">
			@csrf
			<div class="card-body">
				<x-admin-form-model :register="null">
					<div class="row">
						<div class="col-3 col-sm-3 col-lg-2 col-xl-2">
							<x-image-uploaded-file class="image_uploaded_file" :filename="null" noimage="/images/admin/user-no-image.png"/>
						</div>
