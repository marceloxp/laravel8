...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function trim($p_field_name = '')
        {
                        return \Illuminate\Support\Collection::trim($p_field_name);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function toLower($p_field_name = '')
        {
                        return \Illuminate\Support\Collection::toLower($p_field_name);
        }
                    /**
         * 
         *
         * @see \App\Providers\XpCollectionServiceProvider::boot()
         * @param mixed $p_field_name
         * @param mixed $p_separator
         * @static 
         */ 
        public static function slugify($p_field_name = '', $p_separator = '-')
        {
                        return \Illuminate\Support\Collection::slugify($p_field_name, $p_separator);
        }
                    /**
         * 
         *
         ...
         *
         * @see \App\Providers\XpCollectionServiceProvider::boot()
         * @param mixed $p_old_key_name
         * @param mixed $p_new_key_name
         * @static 
         */ 
        public static function renameKey($p_old_key_name, $p_new_key_name)
        {
                        return \Illuminate\Support\Collection::renameKey($p_old_key_name, $p_new_key_name);
        }
                    /**
         * 
         *
         * @see \App\Providers\XpCollectionServiceProvider::boot()
         * @param mixed $p_from_key_name
         * @param mixed $p_to_key_name
         * @static 
         */ 
        public static function toggleKey($p_from_key_name, $p_to_key_name)
        {
                        return \Illuminate\Support\Collection::toggleKey($p_from_key_name, $p_to_key_name);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function moveKey($p_from_key_name, $p_to_key_name)
        {
                        return \Illuminate\Support\Collection::moveKey($p_from_key_name, $p_to_key_name);
        }
