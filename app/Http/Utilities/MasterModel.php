...
class MasterModel extends Model
{
	...
	public function scopeGtCurrentDate($q, $p_field_name)
	{
		return $q->where($p_field_name, '>', Carbex::currentDate()->toSqlDate());
	}

	public function scopeGteCurrentDate($q, $p_field_name)
	{
		return $q->where($p_field_name, '>=', Carbex::currentDate()->toSqlDate());
	}

	public function scopeLtCurrentDate($q, $p_field_name)
	{
		return $q->where($p_field_name, '<', Carbex::currentDate()->toSqlDate());
	}

	public function scopeLteCurrentDate($q, $p_field_name)
	{
		return $q->where($p_field_name, '<=', Carbex::currentDate()->toSqlDate());
	}

	public function scopeGtCurrentDateTime($q, $p_field_name)
	{
		return $q->where($p_field_name, '>', Carbex::currentDateTime()->toSqlDateTime());
	}

	public function scopeGteCurrentDateTime($q, $p_field_name)
	{
		return $q->where($p_field_name, '>=', Carbex::currentDateTime()->toSqlDateTime());
	}

	public function scopeLtCurrentDateTime($q, $p_field_name)
	{
		return $q->where($p_field_name, '<', Carbex::currentDateTime()->toSqlDateTime());
	}

	public function scopeLteCurrentDateTime($q, $p_field_name)
	{
		return $q->where($p_field_name, '<=', Carbex::currentDateTime()->toSqlDateTime());
	}
	...
	public function scopeUntilToday($q, $p_field_name)
	{
		return $q->where($p_field_name, '<', carbex::now()->toSqlDate());
	}
	...
	public function scopeByName($q, $p_name)
	{
		return $q->where('name', $p_name);
	}
