...
class ImageUploadedFile extends Component
{
    ...
    {
        $noimage_path = ($this->noimage) ? $this->noimage : 'img/admin/no-image.png';
        ...
        switch ($extension) {
            ...
            case 'pdf':
                return sprintf('<img {{ $attributes }} src="%s?v=%s">', vasset('/img/admin/fileextensions/pdf.png'), app_version('0.0.1'));
        }
