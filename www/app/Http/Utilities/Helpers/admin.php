...
if (!function_exists('admin_meme_status'))
{
	function admin_meme_status($p_field_value)
	{
		switch ($p_field_value)
		{
			case 'Enviado':
				return bs_label('0', $p_field_value, 'bg-yellow');
			break;
			case 'Aprovado':
				return bs_label('0', $p_field_value, 'bg-green');
			break;
			case 'Reprovado':
				return bs_label('0', $p_field_value, 'bg-red');
			break;
		}
	}
}
