...
<html>
	<head>
		...
		<style>
			...
			body
			{
				/*background-image: url({{ url('/images/admin/background.jpg') }})*/
			}
		</style>
	...
	<body class="hold-transition skin-blue sidebar-mini">
				...
				<nav class="navbar navbar-static-top">
					...
					<div class="navbar-custom-menu">
						<ul class="nav navbar-nav">
							<li>
								<a href="#"><span class="fas fa-pencil-ruler"></span>&nbsp;&nbsp;Tema:&nbsp;{{ get_current_day_theme()->name }}</a>
							</li>
							<li>
								<a href="#"><span class="fas fa-gamepad"></span>&nbsp;&nbsp;Fase:&nbsp;{{ get_current_day_fase() }}</a>
							</li>
							<li>
		...
		<!-- Font Awesome -->
		<script src="{{ vasset('/admin-lte-custom/fontawesome-free-5.8.1-web/js/fontawesome.min.js') }}"></script>
		<!-- Scripts -->
		<script type="text/javascript" src="{{ vasset('/lib/cjsbaseclass.slim.min.js') }}" data-jquery-exclusive="true" data-silent-host="www.site-production.com"></script>
